...
Another common formula is to use $\frac{1}{n}$ rather than $\frac{1}{n -
1}$. For small samples, ie. fewer than 10 this is really too optimistic.
...
longer to get to the target and they drop more.

The only reason rifle shooters are interested in 

Precision rifle shooters shoot small groups at
distance. This can't be done if 

More interesting is a [prediction
interval](https://robjhyndman.com/hyndsight/intervals/) for the next round
